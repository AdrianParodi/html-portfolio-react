...
const CardTestimonio=({foto, descripcion})=>{
    return (
        <Flex className='tarjeta-testimonios' flexDirection='column' alignItems='center' textAlign='center' borderStyle='dashed' borderWidth='1px' borderColor={colors.color3} width={['48%','46%','46%','23%']} borderRadius='20px' py='15px' px='10px' my='20px'>
