...
const CardDestacado = ({titulo, icono, descripcion}) => {
    ...
    return(
        <Flex flexDirection='column' className='tarjeta-destacados' borderColor={colors.color3} borderStyle='dashed' borderWidth='1px' borderRadius='20px' width={['48%','30%']} alignItems='center' flexWrap='wrap' my={['20px','40px']} p='20px' textAlign='center' alignContent='center' >
