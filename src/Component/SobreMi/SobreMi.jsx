...
const SobreMi=()=>{
  ...
  const tarjetasDestacado = [
    ...
    titulo:"Diseño Web",
    icono:faDesktop,
    descripcion: "Foco en el diseño responsive de sitios web y sus funcionalidad con JS."},

    {key:2,
    titulo:"Backend de aplicaciones", 
    icono:faMobileScreenButton, 
    descripcion:"Desarrollo de funcionalidades para 2 aplicaciones disponibles en la App Store de Google."},

    {key:3,
    titulo:"+ 90% de éxito",
    icono:faChartLine,
    descripcion:"En proyectos desarrollados como freelancer."}
  ]
    ...
    return(
      ...
      <Flex alignItems='center' ml={['0px']} width='auto'> 
        ...
        <Flex flexDirection='column'borderColor={colors.color2} borderStyle='dashed' borderWidth='1px' borderRadius='25px' px={['5px','10px','20px']} py={['15px','25px','30px']} flexGrow={1} minWidth={0} >
          ...
          <Text my='30px'> Actualmente brindo mis servicios en <em>Upwork.com</em> en el área de ingeniería y programación, principalmente en Matlab y en Python. Asimismo, trabajo en el desarrollo del backend para aplicaciones en Android y en el desarrollo web. <br/> Adicionalmente, brindo clases de química en idioma inglés desde hace 7 años en la plataforma <em>Tutor.com.</em></Text>

          <Link to="servicios" smooth={smooth} duration={duration} offset={offset}>

            <Button bg={colors.color3} color={colors.color1} borderRadius='20px' borderColor={colors.color3} borderStyle='solid' borderWidth='1px' fontSize={['14px','16px','16px']} fontWeight= {['700','600']} alignItems='center' width={['98%','90%','100%','80%','66%','60%']} py={['15px','25px']} _hover={{color: colors.color3, bg:colors.color1,
