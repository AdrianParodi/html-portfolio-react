...
const CardServicio=({titulo, icono, descripcion})=>{
    const fS1 = ['16px','18px'] //fontSize
    const fW1 = 600 //fontWeight
    return(
        <Flex className='tarjeta-servicios' flexDirection='column'  width={['48%','46%','46%','30%']}  borderStyle='dashed' borderColor={colors.color3} borderWidth='1px' borderRadius='20px' my='20px' p='20px'>
            ...
            <Flex className="textoMasBoton" flexDirection='column' alignItems='center' textAlign='center' flex='1'>
                ...
                <Button bg={colors.color3} color={colors.color1} borderRadius='20px' fontSize={fS1} fontWeight={fW1} width={['8rem','7rem',]} mt='auto'>Detalles</Button>
            </Flex>
        </Flex>
